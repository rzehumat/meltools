...
("COR-MCRP.n",
"kg",
"Total control poison mass in cell n."),
("COR-MCRP-TOT",
"kg",
"Total control poison in core."),
("COR-MINC.n",
"kg",
"Total Inconel mass in cell n."),
("COR-MINC-TOT",
"kg",
"Total Inconel in core."),
("COR-MSS.n",
"kg",
"Total steel mass in cell n."),
("COR-MSSOX.n",
"kg",
"Total steel oxide mass in cell n."),
("COR-MSS-TOT",
"kg",
"Total steel in core."),
("COR-MSX-TOT",
"kg",
"Total steel oxide in core."),
("COR-MUO2.n",
"kg",
"Total UO2 mass in cell n."),
("COR-MUO2-TOT",
"kg",
"Total UO2 in core."),
("COR-MZR.n",
"kg",
"Total Zircaloy mass in cell n."),
("COR-MZRO2.n",
"kg",
"Total ZrO2 mass in cell n."),
("COR-MZR-TOT",
"kg",
"Total Zircaloy in core."),
("COR-MZX-TOT",
"kg",
"Total ZrO2 in core."),
("COR-DC.m.k.n",
...
("COR-PB.m.n",
"kg",
"Particulate debris mass for material m in bypass of cell n."),
("COR-PD.m.n",
"kg",
"Particulate debris mass for material m in cell n."),
("COR-M.m.k.n",
"kg",
"Total mass (intact plus conglomerate) of material m in component k in cell n."),
("COR-MUO2-FU.n",
"kg",
"Intact fuel UO2 mass in cell n."),
("COR-MZR-CL.n",
"kg",
"Intact cladding Zircaloy mass in cell n."),
("COR-MZR-CN.n",
"kg",
"Intact canister (including CB) Zircaloy mass in cell n."),
("COR-MSS-OS.n",
"kg",
"Intact other structure (OS) steel mass in cell n."),
("COR-MCRP-OS.n",
"kg",
"Intact other structure (OS) control poison mass in cell n."),
("COR-MZRO2-CL.n",
"kg",
"Intact cladding ZrO2 mass in cell n."),
("COR-MZRO2-CN.n",
"kg",
"Intact canister (including CB) ZrO2 mass in cell n."),
("COR-MSSOX-OS.n",
"kg",
"Intact other structure steel oxide mass in cell n."),
("COR-MUO2-DB.n",
"kg",
"Total UO2 debris mass in cell n."),
("COR-MZR-DB.n",
"kg",
"Total Zircaloy debris mass in cell n."),
("COR-MSS-DB.n",
"kg",
"Total steel debris mass in cell n."),
("COR-MZRO2-DB.n",
"kg",
"Total ZrO2 debris mass in cell n."),
("COR-MSSOX-DB.n",
"kg",
"Total steel oxide debris mass in cell n."),
("COR-MCRP-DB.n",
"kg",
"Total control poison debris mass in cell n."),
("COR-AFLMIN.m.n",
"m2",
...
("COR-VOL-FLUB.n",
"m3",
"Volume of fluid in bypass of cell n (zero for PWR)."),
("COR-VOL-FLUC.n",
"m3",
"Volume of fluid in channel of cell n (total for PWR)."),
("COR-VOLF-FU.n",
"none",
"Intact fuel volume fraction in cell n."),
("COR-VOLF-CL.n",
"none",
"Cladding volume fraction in cell n."),
("COR-VOLF-CN.n",
"none",
"Canister volume fraction in cell n."),
("COR-VOLF-OS.n",
"none",
"OS \"other structure\" volume fraction in cell n."),
("COR-VOLF-SS.n",
"none",
"Supporting structure volume fraction in cell n."),
("COR-VOLF-NS.n",
"none",
"Nonsupporting structure volume fraction in cell n."),
("COR-VOLF-PB.n",
"none",
"Particulate debris volume fraction in bypass of cell n."),
("COR-VOLF-PD.n",
"none",
"Particulate debris volume fraction in cell n."),
("COR-VOLF-FLB.n",
"none",
"Fluid volume fraction in cell bypass of cell n."),
("COR-VOLF-FLC.n",
"none",
"Fluid volume fraction in channel of cell n (BWR only)."),
("COR-VOLF-FL.n",
"none",
"Fluid volume fraction in cell n."),
("COR-TFU.n",
"K",
"Temperature of UO2 in cell n."),
("COR-TCL.n",
"K",
"Temperature of Zircaloy cladding in cell n."),
("COR-TCN.n",
"K",
"Temperature of canister (the part not adjacent to the control blade) in cell n."),
("COR-TCB.n",
"K",
"Temperature of canister adjacent to control blade."),
("COR-TOS.n",
"K",
"Temperature of OS \"other structure\" in cell n."),
("COR-TSS.n",
"K",
"Temperature of supporting structure in cell n."),
("COR-TNS.n",
"K",
"Temperature of nonsupporting structure in cell n."),
("COR-TPB.n",
"K",
"Temperature of particulate debris in bypass cell n."),
("COR-TPD.n",
"K",
"Temperature of particulate debris in cell n."),
("COR-TSVC.n",
"K",
"Local channel fluid temperature seen by cell n."),
("COR-TSVB.n",
"K",
"Local bypass fluid temperature seen by cell n."),
("COR-MLTFR.n.m.k",
"none",
"Melt fraction of material number m in component number k in cell n."),
("COR-ENERGY-TOT",
"J",
"Total internal energy in COR package."),
("COR-EFPD-TOT",
"J",
"Total cumulative fission power and decay heat generated in core."),
("COR-EMWR-TOT",
"J",
"Total cumulative oxidation heat generated in core."),
("COR-EB4C-TOT",
"J",
"Total cumulative heat from B4C reactions in core."),
("COR-ECNV-TOT",
"J",
"Total cumulative energy transfer to CVH package."),
("COR-EBND-TOT",
"J",
"Total cumulative energy transfer to HS package."),
("COR-EFPD-RAT",
"W",
"Total fission power and decay heat generation rate in core."),
("COR-EMWR-RAT",
"W",
"Total oxidation heat generation rate in core."),
("COR-EB4C-RAT",
"W",
"Total heat generation rate from B4C reactions in core."),
("COR-ECNV-RAT",
"W",
"Total convective heat generation rate in core."),
("COR-EBND-RAT",
"W",
"Total radiative heat transfer rate to boundary heat structures."),
("COR-QCNV.m",
"W",
"Heat transfer rate to atmosphere in fluid volume m."),
("COR-HTCLH.i",
"W/m2-K",
...
("COR-QFLXLH.i",
"W/m2-K",
"Heat flux from ring i of lower head to water pool."),
("COR-QFLXLH-AVG",
"W/m2-K",
"Average heat flux from lower head to water pool."),
("COR-QTOTLH.i",
"J",
...
("COR-SS-STRESS.ijj",
"Pa",
"Maximum component of stress in SS in core cell ijj."),
("COR-SS-DAMAGE.ijj",
"none",
...
("COR-DMH2-TOT",
"kg",
"Total cumulative hydrogen production in core."),
("COR-DMCO-TOT",
"kg",
"Total cumulative carbon monoxide production in core."),
("COR-DMCO2-TOT",
"kg",
...
("COR-MCTOHS-TOT",
"kg",
"Total mass added to HS by COR."),
("COR-ECTOHS-TOT",
"J",
"Total enthalpy of mass added to HS by COR."),
("COR-MCTOBH-TOT",
"kg",
"Total mass added to BH by COR."),
("COR-ECTOBH-TOT",
"J",
"Total enthalpy of mass added to BH by COR."),
("COR-RCTOBH-TOT",
"J",
"Total energy radiated to BH debris by COR."),
("COR-TPN.n",
"K",
"Temperature of penetration n."),
("COR-TLH.ijj",
"K",
"Temperature of vessel lower head node."),
("COR-VSTRAIN.ijj",
"dimensionless",
"Plastic strain in vessel lower head node."),
("COR-VSTRESS.ijj",
"Pa",
"Stress in vessel lower head node."),
("COR-ABRCH",
"m2",
"Total flow area of vessel breach."),
("COR-MEJEC-TOT",
"kg",
"Total debris mass ejected through vessel breach."),
("COR-DT",
"s",
"COR package time step."),
("COR-NCYCLE",
"none",
"Total number of COR package subcycles."),
("COR-CPU",
"s",
"Total CPU usage by run portion of COR package."),
("COR-MASSERR",
"kg",
"Total mass error for COR package."),
("COR-ENERGYERR",
"J",
"Total energy error for COR package."),
("COR-REL-ENGY-ERR",
"dimensionless",
...
("COR-CRUST-THICK",
"m",
"Thickness of crust formed at lower head (by segment)"),
("CVH-CLIQLEV.n",
"m",
"Collapsed liquid elevation in control volume n."),
("CVH-CPUT",
"s",
"Total CPU usage by the RUN (time-advancement) portion of CVH package"),
("CVH-CPUE",
"s",
"CPU usage for edit in RUN portion of CVH package."),
("CVH-CPUC",
"s",
"CPU usage for calculations in RUN portion of CVH package."),
("CVH-CPUR",
"s",
"CPU usage to process restart file in RUN portion of CVH package."),
("CVH-E.n",
"J/kg",
"Specific internal energy in control volume n."),
("CVH-E.m.n",
"J/kg",
"Specific internal energy of material m in control volume n."),
("CVH-ECV.n",
"J",
"Total internal energy in control volume n."),
("CVH-ECV.m.n",
"J",
"Total internal energy of material m in control volume n."),
("CVH-H.n",
"J/kg",
"Specific enthalpy in control volume n."),
("CVH-H.m.n",
"J/kg",
"Specific enthalpy of material m in control volume n."),
("CVH-LIQLEV.n",
"m",
"Swollen liquid elevation in control volume n."),
("CVH-MASS.n",
"kg",
"Mass of material in control volume n."),
("CVH-MASS.m.n",
"kg",
"Mass of material m in control volume n."),
("CVH-P.n",
"Pa",
"Pressure of control volume n."),
("CVH-PPART.m.n",
"Pa",
"Partial pressure of material m in control volume n."),
("CVH-PSAT(TLIQ).n",
"Pa",
...
("CVH-RHO.n",
"kg/m3",
"Net mass density of all materials in control volume n."),
("CVH-RHO.m.n",
"kg/m3",
"Mass density of material m in control volume n."),
("CVH-RHOA.n",
"kg/m3",
"Mass density of atmosphere in control volume n."),
("CVH-RHOP.n",
"kg/m3",
"Mass density of pool in control volume n."),
("CVH-TLIQ.n",
"K",
"Pool temperature in control volume n."),
("CVH-TOT-E",
"J",
...
("CVH-TOT-M",
"kg",
"Total mass in the control volume hydrodynamics package."),
("CVH-TOT-M.m",
"kg",
...
("CVH-TVAP.n",
"K",
"Atmosphere temperature in control volume n."),
("CVH-VELVAPCV.n",
"m/s",
"Velocity of atmosphere in control volume n."),
("CVH-VELLIQCV.n",
"m/s",
"Velocity of pool in control volume n. (units = m/s)"),
("CVH-VIRVOVAP.n",
"m3",
"Virtual volume in atmosphere in control volume n."),
("CVH-VIRVOLIQ.n",
"m3",
"Virtual volume in pool in control volume n."),
("CVH-VOID.n",
"dimensionless",
"Void (non-pool) volume fraction in control volume n."),
("CVH-VOLFOG.n",
"m3",
"Volume of fog in control volume n."),
("CVH-VOLLIQ.n",
"m3",
"Swollen volume of pool (including any vapor bubbles) in control volume n."),
("CVH-VOLVAP.n",
"m3",
"Volume of gaseous atmosphere in control volume n."),
("CVH-X.m.n",
"dimensionless",
...
("FL-MFLOW.m.n",
"kg/s",
"Mass flow rate of material m through flow path n."),
("FL-V-N-OC.n",
"dimensionless",
"Number of times valve number n has opened or closed. Any area fraction greater than 0.0 is considered \"open\"."),
("FL-VELLIQ.n",
"m/s",
"Velocity of pool through flow path n."),
("FL-VELVAP.n",
"m/s",
"Velocity of atmosphere through flow path n."),
("FL-VOID.n",
"dimensionless",
"Void fraction in flow path n."),
("SPR-TP.n",
"K",
"Temperature of spray droplets from source n"),
("SPR-FL.n",
"m3/s",
"Flow rate of spray droplets from source n"),
("SPR-HTTRAN.j",
"W",
...
("DCH-COREPOW.0",
"W",
"Whole-core decay heat power."),
("DCH-CLSPOW.n",
"W/kg",
"Decay heat power per unit mass for radionuclide class n."),
("DCH-TOTCLSPOW.0",
"W",
"Total decay heat power for all radionuclide classes."),
("CAV-ACTIVE.n",
"(logical",
"Activity flag for cavity n."),
("CAV-MTOT.n",
"kg",
"Total mass in cavity n."),
("CAV-HTOT.n",
"J",
"Total enthalpy for cavity n."),
("CAV-DHR.n",
"W",
"Decay heat rate for cavity n."),
("CAV-MASS.spc.n",
"kg",
...
("CAV-MINALT.n",
"m",
"Minimum cavity altitude."),
("CAV-TMEX.n",
"kg",
"Total mass of gas released from cavity n."),
("CAV-MEX.gas.n",
"kg",
"Total mass of requested gas released from cavity n."),
("CAV-QREA.n",
"W",
"Heating rate by chemical reactions in cavity n."),
("CAV-QCNCT.n",
"W",
...
("CAV-TGASMOL.n",
"mol",
"Total moles of gas released from cavity n."),
("CAV-R.n.i",
"m",
"Radial coordinate of i-th body point in cavity n."),
("CAV-Z.n.i",
"m",
"Axial coordinate of i-th body point in cavity n."),
("CAV-CPUT",
"s",
"Total CPU time used in Cavity package, including computation and I/O."),
("CAV-CPUC",
"s",
"CPU time used for computation in Cavity package."),
("bh-cpu",
"s",
"Total CPU usage required in executing the BH Package ."),
("bh-gas-ener.n",
"j",
...
("FDI-CPU",
"s",
"Total CPU time used for FDI package calculations"),
("HS-CPUC",
"s",
"total CPU time used for HS package calculations"),
("HS-CPUE",
"s",
"total CPU time used for HS package edits"),
("HS-CPUR",
"s",
"total CPU time used for HS package restarts"),
("HS-DEGAS-ENERGY.GGGGG",
"J",
"total energy of released gas from Gas Source GGGGG"),
("HS-DEGAS-MASS.GGGGG",
"kg",
"total mass of released gas from Gas Source GGGGG"),
("HS-DEGAS-RATE.GGGGG",
"kg/s",
"degassing rate of Gas Source GGGGG"),
...
("HS-ENERGY-STORED.CCCCC",
"J",
"stored energy of Heat Structure CCCCC"),
...
("HS-ITER-FREQ",
"none",
"average iteration frequency over all heat structures"),
...
("HS-TEMP.CCCCCMN",
"K",
"temperature at node MN of Heat Structure CCCCC."),
("RN1-CPUC",
"s",
"Total time for the run routines of the RN1 package."),
("RN1-CPUE",
"s",
"Total time for the edit routines of the RN1 package."),
("RN1-CPUR",
"s",
"Total time for the restart routines of the RN1 package."),
("RN1-CPUT",
"s",
"Sum of the run, edit and restart times of the RN1 package."),
("RN1-ATMG.cv",
"kg",
...
("RN1-XMRLSER",
"kg",
"Total radioactive mass released from COR components."),
("RN1-AMG-w-x-y.cv",
"kg",
...
("RN1-TMDTR",
"kg",
"Total radioactive mass deposited on all heat structures."),
("RN1-DHTOT",
"W",
"Total decay heat calculated by RadioNuclide package for all locations of radionuclides."),
("RN1-DHCOR",
"W",
"Total decay heat from the radionuclides in the core."),
("RN1-DHCAV",
"W",
"Total decay heat from the radionuclides in the cavity."),
("RN1-DHDEP",
"W",
"Total decay heat from the radionuclides deposited on the heat structures."),
("RN1-DHATM",
"W",
"Total decay heat from airborne radionuclides."),
("RN1-DHPOL",
"W",
"Total decay heat from radionuclides in the pool."),
("RN1-AMGT-x-y.cv",
"kg",
...
("RN2-CPUC",
"s",
"Total time for the run routines of the RN2 package."),
("RN2-CPUE",
"s",
"Total time for the edit routines of the RN2 package."),
("RN2-CPUR",
"s",
"Total time for the restart routines of the RN2 package."),
("RN2-CPUT",
"s",
"Sum of the run, edit and restart times of the RN2 package."),
("RN2-AMFLT-x.f",
"kg",
"Total aerosol mass of class x on filter f, where f is the filter number."),
("RN2-AMFLT.f",
"kg",
"Total aerosol mass on filter f (sum of RN2-AMFLT-x.f)"),
("RN2-VMFLT-x.f",
"kg",
"Total vapor mass of class x on filter f."),
("RN2-VMFLT.f",
"kg",
"Total vapor mass on filter f (sum of RN2-VMFLT-x.f)."),
("RN2-FLT-QTOT.f",
"W",
...
("RN2-VFLT-TMP.f",
"K",
"Temperature of charcoal bed in vapor filter f."),
("RN2-VFLT-RAD.f",
"kg/s",
...
("COR-TSH.n",
"K",
"Temperature of PWR core shroud in cell n."),
("COR-TFM.n",
"K",
"Temperature of PWR core former in cell n."),
("COR-TMP1.n",
"K",
"Temperature of oxidic molten pool 1 material in cell n."),
("COR-TMP2.n",
"K",
"Temperature of metallic molten pool 2 material in cell n."),
("COR-TMB1.n",
"K",
...
("COR-VOLF-SH.n",
"none",
"PWR core shroud volume fraction in cell n."),
("COR-VOLF-FM.n",
"none",
"PWR core former volume fraction in cell n."),
("COR-VOLF-MP1.n",
"none",
"Molten pool 1 (oxide) volume fraction in cell n."),
("COR-VOLF-MB1.n",
"none",
"Molten pool 1 (oxide) volume fraction in bypass of cell n."),
("COR-VOLF-MP2.n",
"none",
"Molten pool 2 (metallic) volume fraction in cell n."),
("COR-VOLF-MB2.n",
"none",
...
("RN1-PH.nnn",
"none",
"pH of pool in control volume nnn."),
("CAV-ASURF.n",
"m2",
"Area of upper surface of debris pool."),
("CAV-CRUSTB.lay.n",
"m",
"Thickness of frozen crust on lower surface."),
("CAV-CRUSTT.lay.n",
"m",
"Thickness of frozen crust on upper surface."),
("CAV-TSURF.n",
"K",
"Temperature of upper surface of debris pool."),
("CAV-MASSERR.n",
"kg",
"Area of upper surface of debris pool."),
("CAV-ENERGYERR.n",
...
("ESF-QFC-RAT.n",
"W",
"Heat transfer rate for fan cooler n."),
("ESF-QFC-TOT.n",
"J",
"Total energy transfer for fan cooler n."),
("ESF-MFC-RAT.n",
"kg/s",
"Condensation rate for fan cooler n."),
("ESF-MFC-TOT.n",
"kg",
"Total steam condensed for fan cooler n."),
("ESF-PAR-DMH2.n",
"kg/s",
"Per PAR unit H2 removal rate for PAR n."),
("ESF-PAR-IMH2.n",
"kg",
"Total H2 removed for all FPARD units of PAR n."),
("ESF-PAR-DVOL.n",
"m3/s",
"Per PAR unit total gas flow rate for PAR n."),
("ESF-PAR-IVOL.n",
"m3",
"Total volume of gas processed in all FPARD units of PAR n."),
("ESF-PAR-TOUT.n",
"m3/s",
"Outlet gas temperature for PAR n."),
("ESF-PAR-FMOL.n",
"m3",
"Outlet gas H2 mole fraction for PAR n."),
("esf-pccs-vntfl",
"kg",
...
("esf-pccs-totstm",
"kg",
"Cumulative steam removed from the drywell."),
("esf-ics-vntfl",
"kg",
...
("esf-ics-toststm",
"kg",
"Cumulative steam removed from the reactor vessel."),
("RN1-TYCLT-x-n.ty",
"kg",
