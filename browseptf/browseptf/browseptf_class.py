...
class browseptf:
    ...
    def __init__(self, sptf="MELPTF"):
        ...
        self.tdoptions = [
            ...
            "*",
            "Hours",
        ]  # default options for the new chart
        ...
        for tvar in readptf.lVarKey:
            ...
            if len(ss) < 2:  # there is no dash in the variable name
                ...
                if len(ss) < 3:  # there is just one dash in the variable name
                    ...
                    if (
                        len(sd) < 2
                    ):  # split unsuccessful, add the whole variable name to the second column
                        sss = tvar[0]
                        ...
                        sn = readptf.fIsNCG(
                            tvar[0]
                        )  # try special treatment for non-condensables
                        if sss != ssold1:
