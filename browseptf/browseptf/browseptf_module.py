...
#        self.labelxrange.set_justify(gtk.JUSTIFY_LEFT)
        ...
        pass  
        self.rbuttonm = gtk.RadioButton.new_with_label_from_widget(self.rbuttons, "Minutes")
        ...
        pass  
        self.rbuttonh = gtk.RadioButton.new_with_label_from_widget(self.rbuttonm, "Hours")
