    ...
    if iflc >= 0 and iflb >= 0 and ifl >= 0:
        for i in range(len(l[ifl])):
            for j in range(len(l[ifl][i])):
                if l[iflc][i][j] > 0.0 or l[iflb][i][j] > 0.0:
                    l[ifl][i][j] = 0.0
            pass
        pass
    pass
    ...
    for it in ltr:
            ...
            if icv != icv0:
                ...
                if ilw >= 0:
                    ...
                    c.fill(
                        ...
                        [
                            col_down,
                            pyx.deco.filled([col_down]),
                            pyx.deco.color.transparency(xtfc),
                        ],
                    )
                    ...
                    c.fill(
                        ...
                        [
                            col_down,
                            pyx.deco.filled([col_down]),
                            pyx.deco.color.transparency(xtfs),
                        ],
                    )
                pass
            pass
                    ...
                    if lvolf[iv] == "flc" or lvolf[iv] == "fl":
                        ...
                        c.fill(
                            ...
                            [
                                lvolfc[iv],
                                pyx.deco.filled([lvolfc[iv]]),
                                pyx.deco.color.transparency(xtp),
                            ],
                        )
                    else:
                        p = pyx.path.rect(rr, z0, r1 - rr, z1 - z0)
        ...
        for i in range(0, nRings):
            ...
            c.text(
                ...
                z0,
                ss,
                [pyx.text.halign.boxcenter, pyx.text.valign.top, tts],
            )
        # type row numbers
        for i in range(0, nRows):
            ...
            c.text(
                ...
                (z0 + z1) / 2.0,
                ss,
                [pyx.text.halign.boxright, pyx.text.valign.middle, tts],
            )
        pass
        r0 = lr0[0]
        ...
        c.text(
            r0, z0, co.sTitle, [pyx.text.halign.boxleft, pyx.text.valign.bottom, tts]
        )
